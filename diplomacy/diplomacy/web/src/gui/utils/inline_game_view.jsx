    ...
    get(name) {
        ...
        if (name === "rights") {
            ...
            if (this.game.observer_level) {
                let levelName = "";
                if (this.game.observer_level === STRINGS.MASTER_TYPE) levelName = "master";
                else if (this.game.observer_level === STRINGS.OMNISCIENT_TYPE) levelName = "omniscient";
            ...
            if (this.game.controlled_powers && this.game.controlled_powers.length) {
                ...
                elements.push(
                    <div key={1}>
                        <strong>Currently handled power{powers.length === 1 ? "" : "s"}</strong>
                    </div>,
                );
