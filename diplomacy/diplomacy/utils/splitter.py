...
class OrderSplitter(AbstractStringSplitter):
    ...
    def supported_unit(self):
        ...
        return (
            self._parts[self._supported_unit_index]
            if self._supported_unit_index is not None
            else None
        )
    ...
    def support_order_type(self):
        ...
        return (
            self._parts[self._support_order_type_index]
            if self._support_order_type_index is not None
            else None
        )
    ...
    def _split(self):
        ...
        words = (
            self._input_str.strip().split() if isinstance(self._input_str, str) else self._input_str
        )
