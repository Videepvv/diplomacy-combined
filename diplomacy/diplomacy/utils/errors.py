...
MAP_RENAMING_POWER_NOT_SUPPORTED = MapError(
    40, "THE RENAME POWER OPERATOR -> IS NO LONGER SUPPORTED."
)
MAP_POWER_NAME_EMPTY_KEYWORD = MapError(41, "POWER NAME IS EMPTY KEYWORD: %s")
MAP_POWER_NAME_CAN_BE_CONFUSED = MapError(
    42, "POWER NAME CAN BE CONFUSED WITH LOCATION ALIAS OR ORDER TYPE: %s"
)
...
GAME_SUPPORTED_UNIT_CANT_REACH_DESTINATION = GameError(
    27, "SUPPORTED UNIT CANNOT REACH DESTINATION: %s %s"
)
GAME_UNIT_CANT_PROVIDE_SUPPORT_TO_DEST = GameError(
    28, "UNIT CANNOT PROVIDE SUPPORT TO DESTINATION: %s %s"
)
...
GAME_UNIT_CANT_MOVE_VIA_CONVOY_INTO_DEST = GameError(
    39, "UNIT CANNOT MOVE VIA CONVOY INTO DESTINATION: %s %s"
)
