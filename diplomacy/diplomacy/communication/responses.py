...
class Error(_AbstractResponse):
    ...
    params = {strings.MESSAGE: str, strings.ERROR_TYPE: str}
...
class DataGameSchedule(_AbstractResponse):
    ...
    params = {"game_id": str, "phase": str, "schedule": parsing.JsonableClassType(SchedulerEvent)}
...
class DataGameInfo(_AbstractResponse):
    ...
    params = {
        ...
        strings.STATUS: parsing.OptionalValueType(
...
class DataPort(UniqueData):
    ...
    __slots__ = []
    params = {strings.DATA: int}  # DAIDE port
...
class DataTimeStamp(UniqueData):
    ...
    __slots__ = []
    params = {strings.DATA: int}  # microseconds
...
class DataGamePhases(UniqueData):
    ...
    __slots__ = []
    params = {strings.DATA: parsing.SequenceType(parsing.JsonableClassType(GamePhaseData))}
...
class DataGame(UniqueData):
    ...
    __slots__ = []
    params = {strings.DATA: parsing.JsonableClassType(Game)}
