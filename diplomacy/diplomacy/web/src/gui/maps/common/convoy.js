...
export class Convoy extends React.Component {
    render() {
        ...
        dest_loc_x =
            "" +
            Math.round(
                (parseFloat(src_loc_x) + ((dest_vector_length - delta_dec) / dest_vector_length) * dest_delta_x) * 100,
            ) /
                100;
        dest_loc_y =
            "" +
            Math.round(
                (parseFloat(src_loc_y) + ((dest_vector_length - delta_dec) / dest_vector_length) * dest_delta_y) * 100,
            ) /
                100;
