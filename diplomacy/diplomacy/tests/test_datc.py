...
class TestDATC:
    ...
    def test_6_a_5(self):
        ...
        self.set_orders(
            game, "ENGLAND", ["F LON C A YOR - YOR", "A YOR - YOR", "A LVP S A YOR - YOR"]
        )
    ...
    def test_6_c_2(self):
        ...
        self.set_orders(
            game, "TURKEY", ["F ANK - CON", "A CON - SMY", "A SMY - ANK", "A BUL S F ANK - CON"]
        )
        self.process(game)
        assert self.check_results(game, "F ANK", OK)
        assert self.check_results(game, "A CON", OK)
    ...
    def test_6_c_3(self):
        ...
        self.set_units(game, "TURKEY", ["F ANK", "A CON", "A SMY", "A BUL"])
        self.set_orders(
            game, "TURKEY", ["F ANK - CON", "A CON - SMY", "A SMY - ANK", "A BUL - CON"]
        )
        self.process(game)
    ...
    def test_6_c_4(self):
        ...
        self.set_orders(
            game,
            "TURKEY",
            ["A BUL - TRI", "F AEG C A BUL - TRI", "F ION C A BUL - TRI", "F ADR C A BUL - TRI"],
        )
    ...
    def test_6_d_14(self):
        ...
        self.set_orders(game, "AUSTRIA", ["F TRI H", "A VIE S A VEN - TRI"])
        self.set_orders(
            game, "ITALY", ["A VEN - TRI", "A TUR S A VEN - TRI", "F ADR S A VEN - TRI"]
        )
        self.process(game)
        assert self.check_results(game, "F TRI", DISLODGED)
        assert self.check_results(game, "A VIE", VOID)
    ...
    def test_6_d_19(self):
        ...
        self.set_units(game, "TURKEY", ["F ANK"])
        self.set_orders(
            game, "RUSSIA", ["F CON S F BLA - ANK", "F BLA - ANK", "A SMY S F ANK - CON"]
        )
        self.set_orders(game, "TURKEY", "F ANK - CON")
        self.process(game)
        assert self.check_results(game, "F CON", OK)
    ...
    def test_6_d_34(self):
        ...
        self.set_orders(
            game, "GERMANY", ["A BER - PRU", "A SIL S A BER - PRU", "F BAL S A BER - PRU"]
        )
    ...
    def test_6_e_4(self):
        ...
        self.set_orders(
            game, "GERMANY", ["F HOL - NTH", "F HEL S F HOL - NTH", "F SKA S F HOL - NTH"]
        )
        self.set_orders(game, "FRANCE", ["F NTH - HOL", "F BEL S F NTH - HOL"])
        self.set_orders(
            game, "ENGLAND", ["F EDI S F NWG - NTH", "F YOR S F NWG - NTH", "F NWG - NTH"]
        )
    ...
    def test_6_e_5(self):
        ...
        self.set_orders(
            game,
            "ENGLAND",
            ["F EDI S F NWG - NTH", "F YOR S F NWG - NTH", "F NWG - NTH", "F LON S F NWG - NTH"],
        )
        self.set_orders(game, "AUSTRIA", ["A KIE S A RUH - HOL", "A RUH - HOL"])
        self.process(game)
        assert self.check_results(game, "F HOL", BOUNCE)
    ...
    def test_6_e_6(self):
        ...
        self.set_orders(
            game, "FRANCE", ["F NTH - HOL", "F BEL S F NTH - HOL", "F ENG S F HOL - NTH"]
        )
        self.set_orders(game, "AUSTRIA", ["A KIE S A RUH - HOL", "A RUH - HOL"])
        self.process(game)
        assert self.check_results(game, "F HOL", BOUNCE)
    ...
    def test_6_e_11(self):
        ...
        self.set_orders(
            game, "FRANCE", ["A SPA - POR VIA", "F MAO C A SPA - POR", "F LYO S F POR - SPA/NC"]
        )
    ...
    def test_6_e_15(self):
        ...
        self.set_orders(
            game, "FRANCE", ["A KIE - BER", "A MUN S A KIE - BER", "A SIL S A KIE - BER"]
        )
        self.set_orders(
            game, "GERMANY", ["A BER - KIE", "F DEN S A BER - KIE", "F HEL S A BER - KIE"]
        )
        self.set_orders(game, "RUSSIA", ["F BAL S A PRU - BER", "A PRU - BER"])
        self.process(game)
        assert self.check_results(game, "F HOL", OK)
    ...
    def test_6_f_1(self):
        ...
        self.set_orders(
            game,
            "TURKEY",
            ["A GRE - SEV", "F AEG C A GRE - SEV", "F CON C A GRE - SEV", "F BLA C A GRE - SEV"],
        )
        self.process(game)
    ...
    def test_6_f_3(self):
        ...
        self.set_units(game, "FRANCE", "A PAR")
        self.set_orders(
            game, "ENGLAND", ["F ENG C A LON - BRE", "A LON - BRE", "F MAO S A LON - BRE"]
        )
        self.set_orders(game, "FRANCE", "A PAR - BRE")
        self.process(game)
        assert self.check_results(game, "F ENG", OK)
    ...
    def test_6_f_6(self):
        ...
        self.set_orders(
            game,
            "GERMANY",
            ["A HOL S A BEL", "A BEL S A HOL", "F HEL S F SKA - NTH", "F SKA - NTH"],
        )
    ...
    def test_6_f_9(self):
        ...
        self.set_orders(
            game, "ENGLAND", ["F ENG C A LON - BEL", "F NTH C A LON - BEL", "A LON - BEL"]
        )
    ...
    def test_6_f_12(self):
        ...
        self.set_orders(
            game, "ENGLAND", ["F ENG C A LON - BEL", "A LON - BEL", "F IRI C A LON - BEL"]
        )
    ...
    def test_6_f_15(self):
        ...
        self.set_orders(game, "FRANCE", ["A BRE - LON", "F ENG C A BRE - LON"])
        self.set_orders(
            game, "ITALY", ["F IRI C A NAF - WAL", "F MAO C A NAF - WAL", "A NAF - WAL"]
        )
        self.process(game)
        assert self.check_results(game, "F LON", OK)
        assert self.check_results(game, "F WAL", OK)
    ...
    def test_6_f_17(self):
        ...
        self.set_orders(game, "ENGLAND", ["F LON S F WAL - ENG", "F WAL - ENG"])
        self.set_orders(
            game, "FRANCE", ["A BRE - LON", "F ENG C A BRE - LON", "F YOR S A BRE - LON"]
        )
        self.set_orders(game, "GERMANY", ["F NTH S F BEL - ENG", "F BEL - ENG"])
        self.process(game)
        assert self.check_results(game, "F LON", OK)
    ...
    def test_6_f_18(self):
        ...
        self.set_units(game, "GERMANY", ["F HEL", "F SKA"])
        self.set_orders(
            game, "ENGLAND", ["F NTH C A LON - BEL", "A LON - BEL", "F ENG S A LON - BEL"]
        )
    ...
    def test_6_f_19(self):
        ...
        self.set_orders(
            game, "FRANCE", ["A TUN - NAP", "F TYS C A TUN - NAP", "F ION C A TUN - NAP"]
        )
    ...
    def test_6_f_21(self):
        ...
        self.set_orders(
            game, "RUSSIA", ["A EDI S A NWY - CLY", "F NWG C A NWY - CLY", "A NWY - CLY"]
        )
        self.set_orders(game, "FRANCE", ["F IRI S F MAO - NAO", "F MAO - NAO"])
        self.set_orders(
            game, "ENGLAND", ["A LVP - CLY VIA", "F NAO C A LVP - CLY", "F CLY S F NAO"]
        )
        self.process(game)
    ...
    def test_6_f_24(self):
        ...
        self.set_orders(
            game,
            "ENGLAND",
            ["F EDI - NTH", "F LON S F EDI - NTH", "F IRI - ENG", "F MAO S F IRI - ENG"],
        )
    ...
    def test_6_g_3(self):
        ...
        self.set_orders(
            game,
            "FRANCE",
            ["F BRE - ENG", "A PIC - BEL", "A BUR S A PIC - BEL", "F MAO S F BRE - ENG"],
        )
    ...
    def test_6_g_9(self):
        ...
        self.set_units(game, "RUSSIA", ["A SWE"])
        self.set_orders(
            game, "ENGLAND", ["A NWY - SWE", "F SKA C A NWY - SWE", "F FIN S A NWY - SWE"]
        )
        self.set_orders(game, "RUSSIA", ["A SWE - NWY"])
        self.process(game)
        assert self.check_results(game, "A NWY", OK)
    ...
    def test_6_g_10(self):
        ...
        self.set_orders(
            game, "ENGLAND", ["A NWY - SWE VIA", "F DEN S A NWY - SWE", "F FIN S A NWY - SWE"]
        )
        self.set_orders(game, "GERMANY", ["F SKA C A NWY - SWE"])
    ...
    def test_6_g_11(self):
        ...
        self.set_orders(
            game, "RUSSIA", ["A SWE - NWY", "F SKA C A SWE - NWY", "F BAR S A SWE - NWY"]
        )
        self.process(game)
        assert self.check_results(game, "F NWY", OK)
        assert self.check_results(game, "F NTH", OK)
    ...
    def test_6_g_12(self):
        ...
        self.set_orders(
            game, "ENGLAND", ["A LVP - EDI VIA", "F NAO C A LVP - EDI", "F NWG C A LVP - EDI"]
        )
        self.set_orders(
            game,
            "GERMANY",
    ...
    def test_6_g_14(self):
        ...
        self.set_units(game, "RUSSIA", ["A SWE", "F BAR"])
        self.set_orders(
            game, "ENGLAND", ["A NWY - SWE", "F DEN S A NWY - SWE", "F FIN S A NWY - SWE"]
        )
        self.set_orders(game, "FRANCE", ["F NWG - NWY", "F NTH S F NWG - NWY"])
    ...
    def test_6_g_15(self):
        ...
        self.set_orders(
            game,
            "ENGLAND",
            ["F NTH C A LON - BEL", "A HOL S A LON - BEL", "A YOR - LON", "A LON - BEL VIA"],
        )
    ...
    def test_6_g_16(self):
        ...
        self.set_orders(
            game,
            "ENGLAND",
            ["A NWY - SWE", "A DEN S A NWY - SWE", "F BAL S A NWY - SWE", "F NTH - NWY"],
        )
        self.set_orders(
            game, "RUSSIA", ["A SWE - NWY VIA", "F SKA C A SWE - NWY", "F NWG S A SWE - NWY"]
        )
        self.process(game)
        assert self.check_results(game, "A NWY", OK)
    ...
    def test_6_g_18(self):
        ...
        self.set_orders(
            game, "FRANCE", ["F ENG C A BEL - LON", "A BEL - LON", "A WAL S A BEL - LON"]
        )
        self.process(game)
        assert self.check_results(game, "F NTH", OK)
        assert self.check_results(game, "A HOL", OK)
    ...
    def test_6_h_1(self):
        ...
        self.set_orders(
            game,
            "ITALY",
            ["A VEN S A TYR - TRI", "A TYR - TRI", "F ION - GRE", "F AEG S F ION - GRE"],
        )
        self.process(game)
        assert self.check_results(game, "F TRI", DISLODGED)
        assert self.check_results(game, "A SER", OK)
    ...
    def test_6_h_2(self):
        ...
        self.set_orders(
            game, "RUSSIA", ["F EDI H", "A SWE S A FIN - NWY", "A FIN - NWY", "F HOL H"]
        )
        self.process(game)
        assert self.check_results(game, "A LVP", OK)
        assert self.check_results(game, "F YOR", OK)
    ...
    def test_6_k_1(self):
        ...
        self.set_units(
            game, "ENGLAND", ["A RUH", "F NTH", "F BOT", "A HOL", "F STP/NC", "F IRI", "A EDI"]
        )
        self.move_to_phase(game, "W1901A")
    ...
    def test_6_k_2(self):
        ...
        self.set_orders(
            game,
            "FRANCE",
            ["F MAO C A BRE - CLY", "F IRI C A BRE - CLY", "A BRE - CLY VIA", "F WES S F MAO"],
        )
