    ...
    onCreate(form) {
        ...
        this.getPage()
            ...
            .then((allPossibleOrders) => {
                ...
                this.getPage().load(`game: ${networkGame.local.game_id}`, <ContentGame data={networkGame.local} />, {
    ...
    render() {
        ...
        return (
            <main>
                ...
                />
                <Tabs menu={["find", "my-games"]} titles={["Find", "My Games"]} onChange={this.changeTab} active={tab}>
                    {tab === "find" ? (
