...
export class PanelChooseSettings extends React.Component {
    ...
    onSetGameID(event) {
        ...
        if (!gameID) gameID = UTILS.createGameID(this.props.username);
                    ...
                    <form>
                        ...
                        <div className="form-group row mb-2">
                            ...
                            <div className="col-md">
                                <input
                                    ...
                                    onChange={this.onSetRegistrationPassword}
                        ...
                        <div className="custom-control custom-checkbox mb-5">
                            <input
                                ...
                                id="no-press"
                                checked={this.props.params.no_press}
                                onChange={this.onCheckNoPress}
                            />
